package com.abrahamyan.liquid
{
	...
	public class ToolTip extends MovieClip
	{
		...
		private function reSize():void
		{
			...
			bg_mc.rect_mc.height = label_txt.textHeight +10;
		...
		private function updatePosition():void
		{
			...
			var newX = Math.round((_horDirection == DIRECTION_LEFT)?(xpos-bg_mc.rect_mc.width+arrowMargin):(xpos-bg_mc.arrow_mc.x));
			var newY = Math.round((_verticalDirection == DIRECTION_TOP)?(ypos - bg_mc.rect_mc.height - bg_mc.arrow_mc.height):(ypos + bg_mc.arrow_mc.height));
			
			var pt:Point = new Point(newX, newY);
