package com.rubberviscous.mvc.view
{
	...
	public class InfoWindowView extends ComponentView
	{
		public function InfoWindowView(aModel:IModel, aController:IController = null)
		{
		...
		{
			if (model.getApplicationState()==model.INFOHOTSPOT) {
				transitionIn();
		...
		public function transitionIn():void
		{
			...
			TweenMax.to(this, .4, {x:stage.stageWidth-this.width, ease:Quad.easeInOut});
		}
